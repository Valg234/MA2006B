...
\hypersetup{
  ...
  linkcolor=black,
  urlcolor=blue,
  pdftitle={Reporte Tecnico - Gestor de Identidades MA2006B 2026},
  pdfauthor={Equipo 5}
}
...
\begin{Verbatim}[frame=single,rulecolor=\color{gray!40},fontsize=\small]
  ...
  Vite Dev Server  ---proxy--->  Apache (puerto 80)
                                ...
                                (puerto 3306)
\end{Verbatim}
\caption{Arquitectura general del sistema Gestor de Identidades (elaboración propia).}
...
La infraestructura de clave pública (PKI) constituye el fundamento teórico de la firma digital implementada en este proyecto. La PKI se basa en la asimetría matemática para garantizar los principios de confidencialidad, integridad y no repudio. De acuerdo con Ramió Aguirre:

``La Criptografía es la rama inicial de las Matemáticas y en la actualidad también de la Informática y la Telemática, que hace uso de métodos y técnicas con el objeto principal de cifrar, y por tanto proteger, un mensaje o archivo por medio de un algoritmo, usando una o más claves'' (Ramió Aguirre, 2006).
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../manual_usuario/capturas/01-login.png}
\caption{Pantalla de inicio de sesión del Gestor de Identidades (elaboración propia).}
\label{fig:login-react}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../manual_usuario/capturas/02-dashboard-admin.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{../manual_usuario/capturas/03-gestor-documentos-inicial.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../manual_usuario/capturas/04-formulario-nuevo-documento.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../manual_usuario/capturas/08-firma-coordinador.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../manual_usuario/capturas/09-ticket-firma.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../manual_usuario/capturas/10-verificacion-firma.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../manual_usuario/capturas/12-documento-finalizado.png}
...
\caption{Matriz de validación y casos de uso del Gestor de Identidades (elaboración propia).}

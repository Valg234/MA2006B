...
El código fuente completo del sistema \textbf{Gestor de Identidades y Documentos} — incluyendo el frontend React, los endpoints PHP del backend, el esquema de base de datos y la documentación del proyecto — se encuentra disponible públicamente en el siguiente repositorio de GitHub:

\begin{center}
  \large\url{https://github.com/Valg234/MA2006B}
\end{center}

El repositorio contiene:

\begin{itemize}
  \item \textbf{casa-monarca-frontend/src/} — Código fuente del frontend React (páginas, componentes y configuración de Vite).
  \item \textbf{casa-monarca-frontend/api/} — Los 22 endpoints PHP del backend.
  \item \textbf{database.sql} — Esquema de la base de datos con datos iniciales.
  \item \textbf{README.md} — Instrucciones de instalación y configuración paso a paso.
  \item \textbf{CHANGELOG.md} — Registro de cambios por versión.
  \item \textbf{TODO.md} — Lista de mejoras y funcionalidades pendientes.
\end{itemize}
